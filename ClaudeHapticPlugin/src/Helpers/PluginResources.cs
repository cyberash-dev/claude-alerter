namespace Loupedeck.ClaudeHapticPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ClaudeHapticPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ClaudeHapticPlugin.Resources.Resource.txt`.
